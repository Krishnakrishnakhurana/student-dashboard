...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password != $confirm_password) {
        ...
        $enrollmentCheckQuery = "SELECT enrollment_number FROM students WHERE enrollment_number='$enrollment_number'";
        ...
        if ($result->num_rows > 0) {
            ...
            $sql = "INSERT INTO students (enrollment_number, name, password) 
                    VALUES ('$enrollment_number', '$name', '$hashed_password')";
    ...
    <div class="registration-container">
        ...
        <form action="register.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="enrollment_number" class="form-control" id="enrollment_number" required>
            </div>
            <div class="mb-3">
